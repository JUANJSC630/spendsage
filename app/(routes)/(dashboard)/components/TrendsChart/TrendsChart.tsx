            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              {(() => {
                ...
                const avgIncome = Math.round(
                  monthsData.reduce((sum, month) => sum + month.income, 0) /
                    monthsData.length,
                );
                const avgExpenses = Math.round(
                  monthsData.reduce((sum, month) => sum + month.expenses, 0) /
                    monthsData.length,
                );
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-100">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-medium text-gray-800">
                          Mes Actual ({currentMonth.monthShort})
                        </h4>
                      </div>
                      <div className="space-y-1 text-sm">
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium text-green-700">
                            {symbol}
                            {formatAmount(currentMonth.income.toString())}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium text-red-700">
                            {symbol}
                            {formatAmount(currentMonth.expenses.toString())}
                          </span>
                        </div>
                        <div className="flex justify-between border-t pt-1">
                          <span className="text-gray-600">Balance:</span>
                          <span
                            className={`font-bold ${currentMonth.balance >= 0 ? "text-blue-700" : "text-red-700"}`}
                          >
                            {currentMonth.balance >= 0 ? "+" : ""}
                            {symbol}
                            {formatAmount(
                              Math.abs(currentMonth.balance).toString(),
                            )}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-1">
                            {incomeChange >= 0 ? "📈" : "📉"}
                            <span
                              className={`font-medium ${incomeChange >= 0 ? "text-green-600" : "text-red-600"}`}
                            >
                              {incomeChange >= 0 ? "+" : ""}
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-1">
                            {expenseChange <= 0 ? "📉" : "📈"}
                            <span
                              className={`font-medium ${expenseChange <= 0 ? "text-green-600" : "text-red-600"}`}
                            >
                              {expenseChange >= 0 ? "+" : ""}
                    ...
                    <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg p-4 border border-amber-100">
                      ...
                      <div className="space-y-1 text-sm">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium text-red-700">
                            {symbol}
                            {formatAmount(Math.round(avgExpenses))}
                          </span>
                        </div>
                        <div className="text-xs text-gray-500 pt-1 border-t">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                {(() => {
                  ...
                  const totalExpenses = monthsData.reduce(
                  ...
                  const highestIncome = Math.max(
                    ...monthsData.map((m) => m.income),
                  );
                  const lowestIncome = Math.min(
                    ...monthsData.map((m) => m.income),
                  );
                  const highestExpenses = Math.max(
                    ...monthsData.map((m) => m.expenses),
                  );
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="flex justify-between border-t pt-1">
                            ...
                            <span
                              className={`font-bold ${overallBalance >= 0 ? "text-green-700" : "text-red-700"}`}
                            >
                              {overallBalance >= 0 ? "+" : ""}
                              {symbol}
                              {formatAmount(
                                Math.round(Math.abs(overallBalance)),
                              )}
                            </span>
                          </div>
                        </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="space-y-1">
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-green-700">
                              {symbol}
                              {formatAmount(Math.round(highestIncome))}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">
                            ...
                            <span className="font-medium text-green-600">
                              {symbol}
                              {formatAmount(Math.round(lowestIncome))}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-red-700">
                              {symbol}
                              {formatAmount(Math.round(highestExpenses))}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-red-600">
                              {symbol}
                              {formatAmount(Math.round(lowestExpenses))}
                            </span>
                          </div>
                        </div>
                      </div>
