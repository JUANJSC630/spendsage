    ...
    <div className="container mx-auto p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="p-4">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Este componente funciona mejor en dispositivos móviles que el
            DatePicker actual.
          </p>
        ...
        <Card className="p-4">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Este componente de rango funciona mejor en dispositivos móviles que
            el DateRangePicker actual.
          </p>
          <div className="max-w-sm">
            <MobileDateRangePicker
              dateRange={dateRange}
      ...
      <div className="mt-8">
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>
            Es altamente personalizable y mantiene el estilo visual actual
          </li>
          <li>Tiene soporte robusto para selección de fechas y rangos</li>
          <li>
            Incluye navegación por mes/año para mejor experiencia de usuario
          </li>
        </ul>
      </div>
    </div>
