...
} from "@/components/ui/react-datepicker";
    ...
    <div className="container mx-auto p-6">
      ...
      <div className="bg-yellow-100 p-4 rounded-md mb-8 border border-yellow-300">
        ...
        <p className="text-yellow-700 mt-2 text-sm">
          Los componentes adaptativos mostrarán automáticamente la versión
          apropiada según tu dispositivo.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <Card className="p-4">
            <h3 className="text-lg font-semibold mb-3">
              Mobile-Friendly (react-datepicker)
            </h3>
            <p className="text-sm text-gray-500 mb-4">
          ...
          <Card className="p-4 border-2 border-green-300">
            ...
            <p className="text-sm text-gray-500 mb-4">
              Detecta automáticamente si es móvil y muestra el componente
              adecuado
            </p>
            <AdaptiveDatePicker
              date={date}
        ...
        <div className="space-y-6">
          ...
          <Card className="p-4">
            ...
            <DateRangePicker
              ...
              onDateChange={(d) =>
                setDateRange({ from: d?.from ?? null, to: d?.to ?? null })
              }
      ...
      <div className="mt-12 p-6 border rounded-md bg-blue-50">
        ...
        <ol className="list-decimal pl-5 space-y-2">
          <li>
            ...
            <code className="bg-gray-100 px-2 py-0.5 rounded">DatePicker</code>{" "}
            por{" "}
          ...
          <li>
            Probar en dispositivos móviles y asegurarse de que todo funcione
            correctamente
          </li>
          <li>
            Para casos específicos donde la solución adaptativa no sea
            suficiente, utilizar directamente los componentes{" "}
            <code className="bg-gray-100 px-2 py-0.5 rounded">
              MobileDatePicker
            </code>{" "}
            o{" "}
